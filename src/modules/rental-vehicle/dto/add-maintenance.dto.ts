...
export class AddMaintenanceDto {
  ...
  @ApiProperty({
    description: 'Ngày bắt đầu bảo trì (dd/MM/yyyy HH:mm)',
  ...
  @ApiProperty({
    description: 'Ngày kết thúc bảo trì (dd/MM/yyyy HH:mm)',
    example: '26/12/2024 17:00',
  })
  @TransformDDMMYYYYHHmm()
  @IsDate()
  @IsNotEmpty()
  ...
  @ApiProperty({
    ...
    example: 'Thay nhớt, kiểm tra định kỳ',
  })
  @IsString()
  @IsNotEmpty()
  reason: string;
