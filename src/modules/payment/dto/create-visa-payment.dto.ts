...
export class CreateVisaPaymentDto {
  ...
  @ApiProperty({
    ...
    description: 'Số thẻ Visa (13-19 số)',
  })
  @IsString()
  @IsNotEmpty()
  @Matches(/^[0-9]{13,19}$/, {
    message: 'Số thẻ không hợp lệ (chỉ gồm số, dài 13-19 ký tự)',
  })
  cardNumber: string;

  @ApiProperty({
    example: 'TRAN QUOC TUAN',
    description: 'Tên chủ thẻ (in hoa, không dấu)',
  })
  @IsString()
  @IsNotEmpty()
  @Length(2, 50)
  ...
  @Matches(/^(0[1-9]|1[0-2])\/([0-9]{2})$/, {
    message: 'Định dạng ngày hết hạn phải là MM/YY',
  })
  expiryDate: string;
