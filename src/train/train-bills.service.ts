...
import { TrainBill, TrainBillStatus } from './train-bill.entity';
...
export class TrainBillsService {
  ...
  async create(dto: CreateTrainBillDto): Promise<TrainBill> {
  ...
  async findOne(id: number): Promise<TrainBill> {
  ...
  async update(id: number, dto: UpdateTrainBillDto): Promise<TrainBill> {
