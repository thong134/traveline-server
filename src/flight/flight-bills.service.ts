...
import { FlightBill, FlightBillStatus } from './flight-bill.entity';
...
export class FlightBillsService {
  ...
  async create(dto: CreateFlightBillDto): Promise<FlightBill> {
  ...
  async findOne(id: number): Promise<FlightBill> {
  ...
  async update(id: number, dto: UpdateFlightBillDto): Promise<FlightBill> {
