CREATE SCHEMA IF NOT EXISTS vn_reform;
SET search_path TO vn_reform;

-- DROP TABLE IF EXISTS wards;
-- DROP TABLE IF EXISTS province_after_communes;
...
CREATE TABLE province_after_communes (
...
ALTER TABLE province_after_communes ADD CONSTRAINT provinces_administrative_unit_id_fkey FOREIGN KEY (administrative_unit_id) REFERENCES administrative_units(id);
CREATE INDEX idx_provinces_unit ON province_after_communes(administrative_unit_id);
...
ALTER TABLE wards ADD CONSTRAINT wards_province_code_fkey FOREIGN KEY (province_code) REFERENCES province_after_communes(code);
